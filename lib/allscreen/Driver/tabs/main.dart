...
import 'package:shila/allscreen/Driver/tabs/profiletab.dart';
import 'package:shila/allscreen/Driver/tabs/rating.dart';
...
class _mainDriverState extends State<mainDriver>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //for displaying icons on bottom
...
//     rideRequestRef=FirebaseDatabase.instance.ref().child("Ride Request").push();
...
//       onTap: (){ FocusScope.of(context).unfocus();} ,// for unfocussing the current widget//aru tthau ma click gare keyword naayos vanera
//       child: Scaffold(
//         key: scaffoldkey,
//         appBar: AppBar(
...
//                                   crossAxisAlignment: CrossAxisAlignment.start,
//                                   children: [
//                                     Text("Car", style: TextStyle(fontSize: 18.0,fontFamily: "Brand semibold"),),
//                                     Text("10 Km", style: TextStyle(fontSize: 16.0, color: Colors.grey),),
//                                   ],
//                                 ),
//                                 Expanded(child: Container()),
//                                // Text(( '\Rs.${AssistanMethods.calculateFares(tripdirectionDetails!)}'), 
...
//                             child: Row(
//                               children: [
//                                 Icon(Icons.money,size: 18.0,color: Colors.black,),
//                                 SizedBox( width: 16.0,
//                                 ),
//                                 Text("Cash"), 
//                                 SizedBox(width:6.0),
...
//                                 children: [
//                                   Text("Request", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold,color: Colors.black),),
//                                   Icon(FontAwesomeIcons.taxi,color: Colors.white,size: 27.0,),
//                                 ],
//                               ),
//                              )),)
//                           ],
...
//     var pickUpLatLng = LatLng(initalPos.latitude!, initalPos.longitude!); // ! it must not be null soo 
//     var dropOffLocation = LatLng(finalPos.latitude!, finalPos.longitude!);
...
//     var details = await AssistanMethods.obtainPlaceDirectionDetails(pickUpLatLng, dropOffLocation);
//     setState(() {
...
//    if(pickUpLatLng.latitude>dropOffLocation.latitude && pickUpLatLng.longitude>dropOffLocation.longitude){
//     latLngBounds =LatLngBounds(southwest: dropOffLocation, northeast: pickUpLatLng);
//    }
//      else if(pickUpLatLng.latitude>dropOffLocation.latitude){
//     latLngBounds =LatLngBounds(southwest: LatLng(dropOffLocation.latitude,pickUpLatLng.longitude) , northeast:  LatLng(pickUpLatLng.latitude,dropOffLocation.longitude));
//    }
//       else if(pickUpLatLng.longitude>dropOffLocation.longitude){
//     latLngBounds =LatLngBounds(southwest: LatLng(pickUpLatLng.latitude,dropOffLocation.longitude) , northeast:  LatLng(dropOffLocation.latitude,pickUpLatLng.longitude));
//    }
//    else{
//     latLngBounds =LatLngBounds(southwest: pickUpLatLng, northeast: dropOffLocation);
//    }
//    // reinitalizing  the map  with suitable pickup and destination 
//    newgoogleMapController?.animateCamera(CameraUpdate.newLatLngBounds(latLngBounds, 70));
//    //marker and circles
//    Marker pickUpLocMarker= Marker(markerId: MarkerId("pickUpId"),
//    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueBlue),
//    infoWindow: InfoWindow(title: initalPos.placeName,snippet: "PickUp Location"),
//    position: pickUpLatLng); //pickup 

//    Marker dropOffLocMarker= Marker(markerId: MarkerId("dropOffId"),
//    icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed),
//    infoWindow: InfoWindow(title: finalPos.placeName,snippet: "PickUp Location"),
